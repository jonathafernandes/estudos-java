...
public class AV1 {
    ...
    public static void sensorTemperatura() {
        ...
        System.out.println("--------------------------------------------");
        System.out.println("Iniciando a captura dos dados da temperatura");
        System.out.println("--------------------------------------------");
        for (l = 0; l < linha; l++) {
            for (c = 0; c < coluna; c++) {
        ...
        System.out.println("---------- Relatório da mediação ----------");
        for (l = 0; l < linha; l++) {
            for (c = 0; c < coluna; c++) {
    ...
    public static void sensorUmidade() {
        ...
        System.out.println("--------------------------------------");
        System.out.println("Iniciando captura dos dados da umidade");
        System.out.println("--------------------------------------");
        for (l = 0; l < linha; l++) {
            for (c = 0; c < coluna; c++) {
                Format formato = new SimpleDateFormat("HH:mm");
    ...
    public static void sensorCarbonico() {
        ...
        int[][] matriz = new int[linha][coluna];
        System.out.println("---------------------------------------");
        System.out.println("Iniciando captura dos dados do gás carbônico");
        System.out.println("---------------------------------------");
        for (l = 0; l < linha; l++) {
            for (c = 0; c < coluna; c++) {
                Format formato = new SimpleDateFormat("HH:mm");
